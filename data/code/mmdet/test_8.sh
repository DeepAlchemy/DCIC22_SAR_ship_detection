...
/data/code/mmdet/tools/dist_test.sh /data/code/mmdet/configs/swin/swin_large_continue_exp2.py /data/code/mmdet/work_dirs/swin_large_continue_exp2/latest.pth 8 --format-only --options "jsonfile_prefix=/data/user_data/intermediate_results/conv_output/swin_large_continue_exp2"
