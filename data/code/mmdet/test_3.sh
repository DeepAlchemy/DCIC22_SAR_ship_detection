...
/data/code/mmdet/tools/dist_test.sh /data/code/mmdet/configs/convnext/cascade_convnext_x_1cls_full_exp4.py /data/code/mmdet/work_dirs/cascade_convnext_x_1cls_full_exp4/latest.pth 8 --format-only --options "jsonfile_prefix=/data/user_data/intermediate_results/conv_output/cascade_convnext_x_1cls_full_exp4"
