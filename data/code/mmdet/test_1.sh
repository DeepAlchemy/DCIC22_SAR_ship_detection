...
/data/code/mmdet/tools/dist_test.sh /data/code/mmdet/configs/convnext/cascade_convnext_x_exp1.py /data/code/mmdet/work_dirs/cascade_convnext_x_exp1/latest.pth 8 --format-only --options "jsonfile_prefix=/data/user_data/intermediate_results/conv_output/cascade_convnext_x_exp1"
